...
//cleans room
	...
	protected synchronized void sendConnectionStatus(ServerThread sender, boolean isConnected) {
		// Changed to a backwards loop to prevent issues with concurrent list modificatio caused by the recursive sendConnectionStatus() function.This change is specific to this method and is not needed elsewhere.
		if (clients == null) {
			return;
		}
		synchronized (clients) {
	...
	protected String formatMessage(String message) {
		...
		//Symbols used to change messages ** -- __
		if(converter == null){
